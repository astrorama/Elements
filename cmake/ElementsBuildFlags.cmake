...
if(NOT ELEMENTS_FLAGS_SET)
  ...
  if (CMAKE_SYSTEM_NAME MATCHES Linux)
    ...
    if("${CMAKE_BUILD_TYPE}" STREQUAL "Profile" AND SGS_COMP_VERSION VERSION_LESS "5.0")
      ...
      if(SGS_OS MATCHES "^conda_(.*)" AND "${CMAKE_BUILD_TYPE}" STREQUAL "Profile")
...
if ( ELEMENTS_CPP11 )
  ...
  if(HAS_C11_FLAG)
    ...
    set(CMAKE_C_STANDARD 11 CACHE STRING "C version selection")
  else()
...
if ( ELEMENTS_CPP17 )
  ...
  if(HAS_CPP17_FLAG AND CMAKE_VERSION VERSION_GREATER_EQUAL "3.8")
  ...
  if(HAS_C17_FLAG AND CMAKE_VERSION VERSION_GREATER_EQUAL "3.21")
    ...
    message(WARNING "The -std=c17 option is not available. Fallback to -std=c11")
    check_c_compiler_flag("-std=c11" HAS_C11_FLAG)
    if(HAS_C11_FLAG)
      set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=c11")
      set(CMAKE_C_STANDARD 11 CACHE STRING "C version selection")
...
if ( ELEMENTS_CPP20 )
  ...
  if(HAS_CPP20_FLAG AND CMAKE_VERSION VERSION_GREATER_EQUAL "3.12")
  ...
  if(HAS_C2X_FLAG)
    ...
    set(CMAKE_C_STANDARD 2X CACHE STRING "C version selection")
  else()
