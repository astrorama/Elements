...
public:
  ...
  /**
   * @brief
   *    Retrieves a reference to the static string.
   * @details
   *    This method returns a constant reference to a static string member.
   *
   * @return A constant reference to the static string.
   */
