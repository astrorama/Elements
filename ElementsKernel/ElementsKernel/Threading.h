...
/// @brief
///   Environment variable containing the default number of threads
...
/// @brief
///   Function to initialize the OneAPI Threading Building Blocks
/// @param var
///   Environment variable to look for the thread numbers. Its default value is
///   stored in #ENV_VAR.
/// @param default_cpu_cores
///   default number of cores if var cannot be found in the environment.
///   Its default value is stored in #DEFAULT_CPU_CORES
/// @details
///   to initialize the number of threads, this function looks first in the number
